...
export default function RoleDemoPage() {
  const cards = [
    ...
    {
      role: "table",
      href: "/customer/order?role=table",
      label: "テーブル用タブレット",
      sublabel: "Customer Table Order",
      description: "お客様向けセルフオーダー。メニュー閲覧・カート・AI相談・お会計呼び出しが使えます。",
      icon: "📱",
    ...
    {
      role: "mobile",
      href: "/customer/order?role=mobile",
      label: "モバイル最適化",
      sublabel: "Customer Mobile Order",
      description: "スマートフォン向けセルフオーダー。縦型レイアウトでメニュー・カート・AIをボトムタブで切り替え。",
      icon: "📲",

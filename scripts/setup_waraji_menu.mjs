...
// 商品画像URL（Wikimedia Commons ライセンスフリー・全URL 200 OK 確認済み 2026-07-09）
const IMG = {
...
// 商品名→画像URLマッピング（IMGはすべて404チェック済み）
const nameToImg = {
  // 焼鳥・串焼き（17品）
  ...
  "ボンジリ串":             IMG.yakitori2,
  "とりホル串":             IMG.liver,
  "ポークフランク串":       IMG.tsukune,
  // 肉巻き串（4品）
  "肉巻き3種串":                 IMG.tsukune,
  "肉巻きプチトマト":            IMG.tomato,
  "えのきとチーズの肉巻き串":    IMG.tsukune,
  "肉巻きうずら":                IMG.tsukune,
  // 野菜串（4品）
  "ししとう":         IMG.edamame,
  "竹の子土佐焼き":   IMG.edamame,
  ...
  // ササミ（5品）
  "ササミ串":            IMG.yakitori1,
  "梅しそササミ串":      IMG.yakitori2,
  "ササミわさび":        IMG.yakitori1,
  "ササミおろしポン酢":  IMG.yakitori2,
  "ササミ3兄弟":         IMG.yakitori1,
  // 冷菜・おつまみ（18品）
  "クリームチーズの特製醤油づけ": IMG.hiyayakko,
  "ねばねばMIX":       IMG.edamame,
  "きゅうりの1本漬け": IMG.greensalad,
  "とりポン":          IMG.chicksalad,
  "えだ豆":            IMG.edamame,
  "宗家キムチ":        IMG.hiyayakko,
  "じゃこおろし":      IMG.hiyayakko,
  "なめたけおろし":    IMG.hiyayakko,
  "じゃこおくら":      IMG.greensalad,
  "オニオンスライス":  IMG.greensalad,
  "みょうがスライス":  IMG.greensalad,
  "おくらスライス":    IMG.greensalad,
  "長芋短冊":          IMG.hiyayakko,
  "やっこ":            IMG.hiyayakko,
  "台湾やっこ":        IMG.hiyayakko,
  "温泉玉子":          IMG.hiyayakko,
  "温玉キムチ":        IMG.hiyayakko,
  "かつおの酒盗":      IMG.hiyayakko,
  // サラダ（3品）
  "シーザーサラダ":  IMG.caesar,
